function OnSpellStart(keys)
  print('fire_mage_attack, onspellstart')
  ...
  abil.castPointTimer = Timers:CreateTimer(3*duration/5, function()
    ...
    caster.cancelAction = nil
    abil:EndCooldown()
    abil:StartCooldown(2*duration/5)

    local projectile = {
      EffectName = "particles/hunter_fire_mage/attack.vpcf",
